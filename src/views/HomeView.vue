...
<template>
    <main class="px-5 py-10 flex flex-col relative">
        <!-- Header section -->
        <header class="flex justify-between items-center mb-6">
            <div>
                <p>Selamat Datang</p>
                <h2 class="font-bold text-lg">Fulan bin Fulan</h2>
            </div>
            <div>
                <img src="../assets/icons/home-userprofile.svg" alt="logo-profile" />
            </div>
        </header>
        ...
        <section>
            ...
            <div class="bg-primary text-light p-6 rounded-lg">
                ...
                <ProgressBar :value="50" :pt="{
                    ...
                    label:
                        'inline-flex text-light dark:text-surface-900 leading-5 text-xs',
                    root: 'overflow-hidden relative border-0 h-5 rounded-xl bg-surface-100 dark:bg-surface-700',
                }">
                </ProgressBar>
            ...
            <div class="mt-10 space-y-4">
                ...
                <div class="h-16 px-6 py-5 flex justify-between rounded- items-center bg-white rounded-lg shadow-lg">
                    ...
                    <div class="rounded-lg bg-green100">
                        <p class="text-xs px-2 py-1">Dilunasi</p>
                    </div>
                </div>
                ...
                <div class="h-16 px-6 py-5 flex justify-between items-center bg-white rounded-lg shadow-lg">
                    ...
                    <div class="rounded-lg bg-red100">
                        <p class="text-xs px-2 py-1">Macet</p>
                    </div>
                </div>
                ...
                <div class="h-16 px-6 py-5 flex justify-between items-center bg-white rounded-lg shadow-lg">
                    ...
                    <div class="rounded-lg bg-blue100">
                        <p class="text-xs px-2 py-1">Rp 100,000,000</p>
                    </div>
                </div>
